...
export default function ConfirmGoods() {
                        ...
                        <Col lg={8}>
                            <div className="confirmGoods_div">
                                ...
                                <div className="cardShop_rightTop">
                                    ...
                                    <div className="rightTop_para">Exclusive Package 10 get 1 free</div>
                                </div>
                                <div className="cg_pack_div">
                                    <Image className="cg_pack_img" src={Package} />
                                    <span className="cg_pack_times">X</span>
                                    <span className="cg_pack_quantity">11</span>
                                </div>
                                <a className="cg_buyBtn_href" href="javascript:;" onClick={handleShow}>
                                    <div className="cg_pack_buy_btn col-lg-8">
                                        <div className="cg_buyBtn_txt">Buy in USDT</div>
                                        <div className="cg_buyBtn_right">100 <span className="cg_pack_u">U</span></div>
                                    </div>
                                </a>
                            </div>
                        </Col>
